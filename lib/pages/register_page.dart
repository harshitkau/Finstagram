...
class _RegisterPageState extends State<RegisterPage> {
  ...
  final GlobalKey<FormState> _regitationFormKey = GlobalKey<FormState>();
  ...
  void _registerUser() async {
    if (_regitationFormKey.currentState!.validate() && _image != null) {
      _regitationFormKey.currentState!.save();
